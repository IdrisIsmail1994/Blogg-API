...
public class UserRepository : IUserRepository
{
	...
	public UserRepository(StudentBloggDbContext dbContext, ILogger<UserRepository> logger)
    {
	...
	public async Task<User?> UpdateUserAsync(int id, User user)
	{
		...
		updateUser.FirstName = string.IsNullOrEmpty(user.LastName) ? updateUser.LastName : user.LastName;
